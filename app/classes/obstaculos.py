...
class Obstaculos:
    def __init__(self, x, y, largura, altura, position=None, textura="barrier.png", modelo="barrieryConcret.obj"):
        self.x = x
        self.y = y
        self.largura = largura
        self.altura = altura
        self.position = position
        self.textura = self.carregar_textura(os.path.join("textures", textura))
        self.vertices, self.textures, self.normals, self.faces = load_obj(f'app/objetos/{modelo}')
